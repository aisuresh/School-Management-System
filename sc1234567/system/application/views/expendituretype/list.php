...
echo "<a href='".$url."expendituretype/export' >";
...
echo '<tr><th colspan = "5" id = "table_title">Expenditure Type List View </th></tr>';
echo "<tr>";
echo "<th align='center' >S.No.</th>";
echo "<th align='center' > <input type = 'hidden' name = 'tablename' class='expendituretype' id ='ordertype'  value = '0' /> </th>";
echo "<th align='center' >Expenditure Group<a class = 'LibraryNo' onClick='sort_fun(this);' >";
echo "<th align='center' >Expenditure Type<a class = 'LibraryNo' onClick='sort_fun(this);' >";
echo "<th align='center' >Description<a class = 'RollNo' onClick='sort_fun(this);' >
</tr>";
$i = 1;
...
echo "<td align='center' ><input type='radio' name = 'ExpenditureTypeId' id = 'ExpenditureTypeId' value ='" . $row->ExpenditureTypeId. "'/></td>";
...
function edit_data(){
   ...
   if(year != currentAcademicYear ){
    ...
    var rollid = $('input:radio[name=ExpenditureTypeId]:checked').val();
  ...
  var currentAcademicYear = $('#currentAcademicYear').val();
   if(year != currentAcademicYear ){
	...
	if(rollid == 'undefined' || rollid == null ){
	 ...
	 window.location='<?=$url?>expendituretype/view/'+rollid;
	}
	}
}	
...
function addnew_data(){	
   ...
   if(year != currentAcademicYear ){
	...
	window.location='<?=$url?>expendituretype/addnew/';
	}
	
}	
function get_list(){
	var year = $('#Year').val();
	window.location='<?=$url?>expendituretype/listview/'+year;
