...
echo '<tr><th colspan = "3" id = "table_title">Create New Class Fees Information</th></tr>';
echo "<tr>";
...
echo "<td width='2%' class='spacetd' > </td>";
echo "<td width='33%' class = 'dataview' ><input type = 'text' name = 'ClassFees' id = 'ClassFees' onKeyUp='JsCheckNumber(this)'/></td>";
echo "</tr>";
echo "</table>";
