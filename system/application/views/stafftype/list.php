...
echo "<a href='".$url."stafftype/export' >";
...
echo "<div class='events'>";
echo "<a href='".$url."stafftype/addnew' >";
...
echo '<tr><th colspan = "4" id = "table_title">Staff Type Details List View </th></tr>';
echo "<tr>";
echo "<th align='center' >S.No.</th>";
echo "<th align='center' > <input type = 'hidden' name = 'tablename' class = 'stafftype' value = '0' /></th>";
...
echo "<td align='center' ><input type='radio' name = 'StaffTypeId' id = 'StaffTypeId' value ='" . $row->StaffTypeId . "'/></td>";
...
<script>
function edit_data(){
	var rollid = $('input:radio[name=StaffTypeId]:checked').val();
...
function view_data(){
	...
	if(rollid == 'undefined' || rollid == null ){
	 ...
	 window.location='<?=$url?>stafftype/view/'+rollid;
	}	 
