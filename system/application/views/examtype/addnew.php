...
echo '<tr><th colspan = "3" id = "table_title">Create New Exam Type Information</th></tr>';
...
echo "<td width='2%' class='spacetd' > </td>";
echo "<td width='33%' class = 'dataview' ><input type = 'text' name = 'ExamMarks' id = 'ExamMarks' value=100 onKeyUp='JsCheckNumber(this)' /> </td>";
echo "</tr>";

echo "<tr>";
echo "<td align='right' width='15%' class = 'datafield' >Pass Marks<span class = 'mandatory'>*</span></td>";
echo "<td width='2%' class='spacetd' > </td>";
echo "<td width='33%' class = 'dataview' ><input type = 'text' name = 'PassMarks' id = 'PassMarks' value=35 onKeyUp='JsCheckNumber(this)' /> </td>";
echo "</tr>";
...
function save_data($e){
 ...
 if(validation()){
		$.ajax({
			...
			data: 'ExamType='+ExamType+'&ExamMarks='+ExamMarks+'&PassMarks='+PassMarks+'&ExamDes='+ExamDes,
